...
<script type="text/javascript">
    ...
    <body onLoad="noBack();" onpageshow="if(event.presisted) noBack();" onunload="">
        ...
        <div class="test" style="margin-left:400px; margin-top:80px;height:90px;">
            ...
            <br>
            <br>
            <form name="vinform" action="Admin_Member.jsp" method="post" >
                ...
                <select name="admin_member" required="required" style= " font-size: 15px; margin-left:-280px; margin-top:-175px;height:40px; width: 450px;" >
                ...
                <div class="u-form-group1">
                    <button id ="btnprofile">ADMIN</button>
                </div>
