...
<html>
    ...
    <body onLoad="noBack();" onpageshow="if(event.presisted) noBack();" onunload=""">
        ...
        <div class="header1">
            ...
            <div id="profilearea1" class="header1"><a href="8_editProfile.jsp"style="color: #ffffff"><%=session.getAttribute("user_name")%></a></div>
            ...
            <a href="Calender.jsp"><img src="calender.png"height="60"/></a>
...
<%
            ...
            <div id="postboxpos" class="post">
                    ...
                    <h6 style="color:red"><br>(Text limit 300 letter)</h6>    
            </div>
       ...
       <%   try {
                ...
                %><div class="postdisplay2">
                    ...
                    <h3 style="float:right;margin-top:-35px;margin-right:20px"><button class="b2">Delete</button></h3>
                    <h4 style="float:right;margin-top:-7px"> <%=post_date%></h4>
